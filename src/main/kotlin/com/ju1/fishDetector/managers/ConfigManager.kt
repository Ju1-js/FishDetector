...
class ConfigManager(private val plugin: FishDetector) {
    ...
    fun load() {
        ...
        afkTimeMillis = c.getLong("afk-time-seconds", 600) * 1000L
        ...
        warningMessage = c.getString("actions.warning-message", "<red><bold>Are you afk? <yellow>Move your mouse!")!!
        broadcastAlert = c.getString("actions.broadcast-alert", "<yellow>%player% stopped fishing due to inactivity.")!!
